...
<div align="center" style="text-align: center">
  <img src = "logo.png" alt="Logo Larry Villegas">  
  <h1><b>Awesome books - ES6 :books: </b></h3>
</div>
...
**[Awesome books]** Is a project about manage modules on `JavaScript`
...
- **Manage Modules for Javascript**
- **Manage content dinamycally**
- **Introduce ES6 features**
- **Manage library Luxon**
...
```sh
  cd my-folder
  git git@github.com:LarryIVC/AwBooksES6v2.0.git
```
### Install
...
Feel free to check the [issues page](https://github.com/LarryIVC/AwBooksES6v2.0/issues).
...
Help me with your criticisms and your suggestions, you will be blessed for such a noble gesture and give me a ⭐️ if you like this project. click [here ⭐️](https://github.com/LarryIVC/AwBooksES6v2.0/stargazers)
